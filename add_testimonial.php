    ...
    if (empty($err)) {
        ...
        $testimonial_text = $_POST['testimonial_text'];
            ...
            try {
                ...
                $sql = "INSERT INTO testimonials (customer, testimonial)
                VALUES (:uname, :testimonial_text)";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <h4 class="mb-3 mb-md-0">ADD NEW TESTIMONIAL</h4>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-listing" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control text-danger" name="uname" id="uname" placeholder="John B" required>
                                    </div>
                                    <div class=" mb-3">
                                        <label for="testimonial_text" class="form-label">Testimonial</label>
                                        <textarea class="form-control text-danger" id="testimonial_text" name="testimonial_text" row="5" required></textarea>
                                    </div>
